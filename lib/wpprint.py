...
class wpprint:
    ...
    def plus(self, string, flag="+"):
        print(f"{self.g}[{flag}]{self.e} {self.nw}{string}{self.e}")

    def test(self, string, flag="*"):
        print(f"{self.b}[{flag}]{self.e} {self.nw}{string}{self.e}")

    def warn(self, string, flag="!"):
        print(f"{self.nr}[{flag}]{self.e} {self.nw}{string}{self.e}")

    def erro(self, string, flag="-"):
        print(f"{self.r}[{flag}]{self.e} {self.nw}{string}{self.e}")

    def info(self, string, flag="i"):
        print(f"{self.y}[{flag}]{self.e} {self.nw}{string}{self.e}")
